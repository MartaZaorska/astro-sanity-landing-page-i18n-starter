...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: (
        <>
          <em>External</em> (other websites), <em>Internal</em> (within your site), or{' '}
          <em>Anchor</em> (section on same page)
        </>
      ),
      options: {
    ...
    defineField({
      ...
      validation: Rule =>
        Rule.custom(async (value, context) => {
          const type = (context.parent as { linkType?: string })?.linkType;
